          ...
          <div className="flex flex-col space-y-4 pb-5 pt-2 bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm rounded-lg p-4 shadow-lg">
            ...
            <div className="border-t border-gray-200 dark:border-gray-700 my-2 pt-4">
              <div className="flex items-center justify-center px-2">
                ...
                <a href="https://github.com/AliShoaibHassan" className="text-gray-800 dark:text-gray-300 hover:text-blue-600 dark:hover:text-red-400 transition-colors text-sm font-medium" target='_blank'>
                  GitHub Profile
                </a>
              </div>
            </div>
